...
global_dof_index DoFHandler<dim, spacedim>::distribute_dofs(std::shared_ptr<fe::FESimplexP<dim, spacedim>> fe) {
    
    // We clear the boundary dofs map
    vertex_dofs.clear();
    edge_dofs.clear();
    face_dofs.clear();
    cell_dofs.clear();
    map_boundary_dofs.clear();
