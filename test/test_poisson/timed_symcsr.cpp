...
int main(int argc, char *argv[])
{
    ...
    linalg::CSRPattern csr_pattern_sym = linalg::CSRPattern::create_symmetric_from_dof_handler(dof_handler);
    linalg::SymCSRMatrix A_sym(n_dofs, csr_pattern_sym);
    ...
    for (auto it = dof_handler.elem_begin(); it != dof_handler.elem_end(); ++it)
    {
        ...
        linalg::MatrixTools::add_local_matrix_to_global(A_sym, local_matrix, local_dofs);
