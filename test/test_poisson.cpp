...
int main(int argc, char *argv[])
{
    ...
    for (auto it = dof_handler.elem_begin(); it != dof_handler.elem_end(); ++it)
    {
        ...
        // std::cout << "v0: " << v0.coords[0] << " " << v0.coords[1] << std::endl;
        // std::cout << "v1: " << v1.coords[0] << " " << v1.coords[1] << std::endl;
        // std::cout << "v2: " << v2.coords[0] << " " << v2.coords[1] << std::endl;

        // std::cout << "lenght_01: " << lenght_01 << std::endl;
        // std::cout << "lenght_12: " << lenght_12 << std::endl;
        // std::cout << "lenght_20: " << lenght_20 << std::endl;
    ...
    std::cout << "dofs on boundary: " << std::endl;
    for(auto it = dof_handler.boundary_dofs_begin(0); it != dof_handler.boundary_dofs_end(0); ++it)
    {
